...
<div class="grid grid-cols-2 gap-4 p-4 bg-zinc-900/50 rounded-xl border border-zinc-800 backdrop-blur-sm mt-4">
	<div class="flex flex-col gap-1">
		...
		<div class="flex items-end gap-2">
			...
			<div class="h-2 flex-1 bg-zinc-800 rounded-full overflow-hidden mb-1.5">
				<div class="h-full bg-red-500/50 transition-all duration-500" style="width: {metrics.SkipRate * 100}%"></div>
			</div>
		</div>
	</div>

	<div class="flex flex-col gap-1 text-right">
		<span class="text-[10px] text-zinc-500 font-bold uppercase tracking-widest">Acoustic Drift</span>
