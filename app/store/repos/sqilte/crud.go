...
import (
	...
	"github.com/david22573/GoRadio/app/utils"
)
...
func (r *sqliteRepo) GetAllStations() ([]types.Station, error) {
	...
	return utils.QueryMultiple(r.db, scanStation, query)
}
...
func (r *sqliteRepo) GetStationByID(id int) (*types.Station, error) {
	...
	return utils.QuerySingle(r.db, scanStation, query, id)
}
...
func (r *sqliteRepo) CreateStation(station *types.Station) error {
	...
	id, err := utils.ExecInsert(r.db, query, station.Name, station.URL)
	if err != nil {
...
func (r *sqliteRepo) UpdateStation(station *types.Station) error {
	...
	_, err := utils.ExecAffected(r.db, query, station.Name, station.URL, station.ID)
	if err != nil {
		// You might want to check for specific errors, e.g., UNIQUE constraint violations
		return err
	}
...
func (r *sqliteRepo) DeleteStation(id int) error {
	...
	_, err := utils.ExecAffected(r.db, query, id)
	return err
}
...
func (r *sqliteRepo) GetAllShows() ([]types.Show, error) {
	...
	return utils.QueryMultiple(r.db, scanShowInternal, query)
}
...
func (r *sqliteRepo) GetAllShowsByStation(stationID int) ([]types.Show, error) {
	...
	return utils.QueryMultiple(r.db, scanShowInternal, query, stationID)
}
...
func (r *sqliteRepo) GetShowByID(id int) (*types.Show, error) {
	...
	return utils.QuerySingle(r.db, scanShowInternal, query, id)
}
...
func (r *sqliteRepo) CreateShow(s *types.Show) error {
	...
	id, err := utils.ExecInsert(r.db, query,
		s.Name,
...
func (r *sqliteRepo) UpdateShow(s *types.Show) error {
	...
	affected, err := utils.ExecAffected(r.db, query,
		s.Name,
		int64(s.Duration.Seconds()),
		int(s.Day),
		s.Hour,
...
func (r *sqliteRepo) DeleteShow(id int) error {
	...
	affected, err := utils.ExecAffected(r.db, query, id)
	if err != nil {
		return err
	}
	if affected == 0 {
